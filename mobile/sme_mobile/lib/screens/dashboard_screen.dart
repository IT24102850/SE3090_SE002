        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              // MyApp will automatically show LoginScreen
            },
          ),
        ],
      ),
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            if (user.role == 'Admin')
              ListTile(
                leading: Icon(Icons.admin_panel_settings, color: roleColor),
          ...
          children: [
            ...
            Card(
              ...
              shape: RoundedRectangleBorder(
                ...
                side: BorderSide(color: roleColor.withOpacity(0.45), width: 2),
              ),
              child: Padding(
                padding: const EdgeInsets.all(16),
                child: Column(
