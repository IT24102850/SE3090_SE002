        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AgentWorkflows_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AgentWorkflows_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AgentWorkflows_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_AgentWorkflows_AgentWorkflowId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentWorkflows_BranchId",
                table: "AgentWorkflows",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentWorkflows_CreatedByUserId",
                table: "AgentWorkflows",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentWorkflows_TenantId",
                table: "AgentWorkflows",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_AvailabilitySlots_ResourceId_StartTime_EndTime",
                table: "AvailabilitySlots",
                columns: new[] { "ResourceId", "StartTime", "EndTime" });

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_AgentWorkflowId",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resources_BranchId_Name",
                table: "Resources",
