...
export function BranchOverviewPage() {
  ...
  function addTransfer(transfer: Omit<Transfer, 'id' | 'status' | 'requestedBy'>) { setTransfers((previous) => [{ ...transfer, id: Date.now(), requestedBy: 'Inventory Admin', status: 'Pending' }, ...previous]); setShowModal(false); }
